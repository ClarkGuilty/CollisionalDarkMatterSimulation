...
\cite{planckCitetion}.   
La presencia de la materia oscura se infiera a trav\'es de los efectos
...
de un distribuci\'on arbitraria de diferentes tipos posibles de
materia oscura. 
...
t\'ermino colisional.
Otras ventajas del m\'etodos es que es lagrangiano,
