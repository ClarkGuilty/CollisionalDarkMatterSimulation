...
double calDensity();//TODO:calcular añadir dimensión
...
double potencial(); //TODO:calcular añadir dimensión
...
double potencialTeorico2(int inx, int iny, int inz, int nx, int ny, int nz);//TODO:calcular añadir dimensión
double densidadTeorica2(int inx, int iny, int inz, int nx, int ny, int nz);//TODO:calcular añadir dimensión
        ...
        for(k1=0; k1<Nx;k1+=1){
            for(k2=0; k2< Ny; k2+=1){
                for(k3=0; k3< Nz; k3+=1){
                    ...
                    totalMass += density[in(k1,k2,k3)];//*dvz*dvy*dvx;
                }
            }
        }
        return totalMass;
